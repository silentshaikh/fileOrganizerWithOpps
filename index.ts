                    ...
                    if(removeName.trim() === ""){
                       ...
                       if(findFileRemov?.name){
                        ...
                        findNameForRemove.files = filtrFiles;
                         ...
                         console.log(chalk.red(chalk.italic(`\n \tFile : ${chalk.cyanBright(chalk.bold(removeName))} is not available\n`)))
                       }
                    }
                }else{
                    //if folder is not available for remove a file
                    console.log(chalk.red(chalk.italic(`\n \tFolder Name: ${chalk.cyanBright(chalk.bold(findFildrName))} is not available.\n`)))
                }
                }
                ...
                if(findFolderForEdit?.name){
                    ...
                    if(findFile?.name){
                        ...
                        if(findDUplictName?.name){
                            console.log(chalk.red(chalk.italic(`\n \tFile Name : ${chalk.cyanBright(chalk.bold(editFileName))} is already exist\n`)))
                        }else{
                        ...
                        console.log(chalk.red(chalk.italic(`\n \tFile : ${chalk.cyanBright(chalk.bold(FileName))} is not avaiable.\n`)));
                    }
                }else{
                    //if folder is available for edit the file
                    console.log(chalk.red(chalk.italic(`\n \tFolder : ${chalk.cyanBright(chalk.bold(findFoldr))} is not available.\n`)))
                }
                }
        ...
        if(Folder.folder.length === 0){
            ...
            if(findFolder.trim() === ""){
                ...
                if(findFolderForDelete?.name){
                    ...
                    console.log(chalk.red(chalk.italic(`\n \tFolder : ${chalk.cyanBright(chalk.bold(findFolder))} is not available.\n`)));
                }
            }
        ...
        if(Folder.folder.length === 0){
            ...
            if(searchFolder.trim() === ""){
                ...
                if(findFolderForShow){
                    ...
                    console.log(chalk.cyanBright(chalk.italic(`\t \t ### FILES ### \n`)))
                    console.log(chalk.cyanBright(`\t ---------------------\n`))
                    if(files.length === 0){
                        console.log(chalk.cyanBright(chalk.italic(` \t### FILES LIST IS EMPTY ###\n`)))
                    console.log(chalk.cyanBright(`\t ---------------------\n`))
                    }else{
                        files.forEach((e:FileType):void => {
                            console.log(chalk.greenBright(chalk.italic(`\t FILE NAME : ${chalk.bold(e.name)} . \n`)));
                            console.log(chalk.greenBright(chalk.italic(`\t FILE PATH : ${chalk.bold(e.path)} . \n`)));
                            console.log(chalk.greenBright(chalk.italic(`\t FILE TYPE : ${chalk.bold(e.type)} . \n`)));
                            console.log(chalk.greenBright(chalk.italic(`\t FILE DATE : ${chalk.bold(e.date.getDate())}-${chalk.bold(e.date.getMonth()+1)}-${chalk.bold(e.date.getFullYear())} . \n`)));
                            console.log(chalk.cyanBright(`\t ---------------------\n`))
                        })
                    }
                }else{
                    ...
                    if(foldrNameForTransferFiles.trim() === ""){
                        ...
                        if(findFoldrForTransferFile?.name){
                            ...
                            if(findFileForTransfer){
                                ...
                                console.log(chalk.red(chalk.italic(`\n \t File : ${chalk.cyanBright(chalk.bold(moveFileInput))} is not available.\n`)));
                            }
                            }
                            }
                        }else{
                            console.log(chalk.italic(chalk.red(`\n \t Folder : ${chalk.cyanBright(chalk.bold(foldrNameForTransferFiles))} is not available.\n`)))
                        }
                    }
                }else{
                    console.log(chalk.italic(chalk.red(`\n \t Folder : ${chalk.cyanBright(chalk.bold(wantFolderForMoveFile))} is not available.\n`)))
                }
            }
